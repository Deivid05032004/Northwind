...
#region Contructores primarios c# 12

public class CreateOrderDto(string customerId, string shipAddress, string shipCity, string shipCountry,
    string shipPostalCode, IEnumerable<CreateOrderDetalDto> orderDetails)
{
    ...
    public IEnumerable<CreateOrderDetalDto> OrderDetails => orderDetails;
}
#endregion
...
//        }
//    }
//    public IEnumerable<CreateOrderDetailDto> OrderDetails
//    {
//        get
//        {
